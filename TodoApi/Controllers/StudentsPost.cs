...
namespace TodoApi.Controllers
{
    [Route("student")]
    [ApiController]
    public class StudentsPost : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public StudentsPost(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: api/TodoItems
        [HttpGet]
        public async Task<ActionResult<CustomStudents>> GetTodoItems()
        {
            ...
            var todoItem = await _context.Students.ToListAsync();
            CustomStudents customstudents = new CustomStudents(await _context.Students.ToListAsync(),await _context.Courses.ToListAsync());
            if (todoItem == null)
            {
                return NotFound();
            }
